// source: https://github.com/ally-ui/ally-ui/blob/main/packages/common/react/lib/mergeReactProps.ts

type AnyProps = Record<string, any>;

export function mergeReactProps(parentProps: AnyProps, childProps: AnyProps, extendProps: AnyProps = {}) {
	...
	return {...parentProps, ...overrideProps, ...extendProps};
}